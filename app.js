...
function setupInfoForm() {
  ...
  if (savedProfiles && savedProfiles.phone && !Array.isArray(Object.values(savedProfiles)[0])) {
  ...
  infoForm.addEventListener("submit", (event) => {
    ...
    if (!infoForm.checkValidity()) {
      formMessage.textContent = getTranslation(translations[activeLanguage], "info.required");
    ...
    formMessage.textContent = getTranslation(translations[activeLanguage], "info.saved");
    
    // Redirect to app.html after 1 second
    setTimeout(() => {
